  ...
  const cardContents = [
    {
      ...
      description:
        "Custom Designed and built LED lighting system made from leftovers from theater production",
    ...
    {
      title: "Feeding Strawberry",
      description: "A Three.js game where you help a hungry fish find food",
      alt: "Feeding Strawberry gameplay",
      body: 'Feeding Strawberry is a game dedicated to the struggles of a hungry fish. The project was made with Three.js and made use of the next.js react framework to handle the inputs and rest of the page. This was a really cool way for me to practice my 3D modeling and game design skills.',
      image: "strawberry.png",
      link: "https://fish.matt-leopold.com",
    },
    {
      title: "Inherit the Wind",
      description:
        "Lighting design for BC Dramatic Society's production of Inherit the Wind",
    ...
    },
    {
      ...
      description:
        "Participated in Bridge2AI summer program analyzing voice as a health biomarker",
    ...
    },
    {
      ...
      description:
        "Website for Ridge High School Sailing team created during Hackathon",
    ...
    },
    {
      title: "Pong",
      description:
        "Pong game made in Unity with multiplayer and single-player modes",
    ...
    },
    {
      ...
      description:
        "HTML and CSS bubble wrap simulator with music and sound effects",
